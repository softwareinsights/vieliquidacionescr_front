...
@Component({
  ...
  styleUrls: [('./liquidacion_has_folios-add-modal.component.scss')],
  templateUrl: './liquidacion_has_folios-add-modal.component.html'
})
export class Liquidacion_has_foliosAddModalComponent extends DialogComponent<Liquidacion_has_foliosInterface, any> implements OnInit {
  _liquidacion: string[] = [];
  _folio: string[] = [];
