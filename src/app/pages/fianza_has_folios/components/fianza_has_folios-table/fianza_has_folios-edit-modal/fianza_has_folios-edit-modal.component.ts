...
@Component({
  ...
  styleUrls: [('./fianza_has_folios-edit-modal.component.scss')],
  templateUrl: './fianza_has_folios-edit-modal.component.html'
})
export class Fianza_has_foliosEditModalComponent extends DialogComponent<Fianza_has_foliosInterface, any> implements OnInit, Fianza_has_foliosInterface {
  _fianza: string[] = [];
  _folio: string[] = [];
