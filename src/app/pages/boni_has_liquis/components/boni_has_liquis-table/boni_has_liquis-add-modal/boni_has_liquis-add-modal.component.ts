...
@Component({
  ...
  styleUrls: [('./boni_has_liquis-add-modal.component.scss')],
  templateUrl: './boni_has_liquis-add-modal.component.html'
})
export class Boni_has_liquisAddModalComponent extends DialogComponent<Boni_has_liquisInterface, any> implements OnInit {
